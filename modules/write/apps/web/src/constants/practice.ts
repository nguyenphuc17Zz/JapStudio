import type { ModeItem } from '../components/practice/PracticeModeSelector'
import type { QuickTopicItem } from '../components/practice/TopicQuickPills'

// Re-export shared JLPT/REGISTER to avoid per-component hardcode duplication
export { JLPT_LEVELS, REGISTER_OPTIONS } from './jlpt'

// Centralized popular topics — single source, can later be fetched GET /api/topics/popular
export const POPULAR_TOPICS: QuickTopicItem[] = [
...
// Centralized practice modes — can be feature-flagged via GET /api/practice/modes
export const PRACTICE_MODES: ModeItem[] = [
...
export type { ModeItem, QuickTopicItem }
export type { PracticeMode } from '../components/practice/PracticeModeSelector'

        ...
        <div className="space-y-1 min-w-0 flex-1">
          {result.promptText && (
            <div className="font-bold font-jp text-foreground">
              Đề: <UniversalFurigana text={result.promptText} fontSize="sm" />
            </div>
          )}
          ...
          <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-[11px]">
            <span className="text-muted-foreground flex items-center gap-1">
              Bạn nói:{" "}
              {result.transcript ? (
                <span className="font-semibold text-foreground font-jp">
                  <UniversalFurigana text={result.transcript} fontSize="sm" />
                </span>
              ) : (
                <span className="font-semibold text-muted-foreground italic">(Trống / Hết giờ)</span>
              )}
            </span>
            ...
            {result.canonicalAnswer && (
              <span className="text-primary font-bold flex items-center gap-1">
                ...
                <span className="font-jp">
                  <UniversalFurigana text={result.canonicalAnswer} fontSize="sm" />
                </span>
              </span>
            )}
          </div>

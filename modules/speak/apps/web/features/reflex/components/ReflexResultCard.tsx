        ...
        <div className="p-4 rounded-2xl bg-card border border-border/80 shadow-xs space-y-3 flex flex-col justify-between">
          <div className="space-y-1.5">
            <div className="flex items-center justify-between gap-2">
              ...
              {result.isWhisperRescued ? (
                <span className="text-[10px] px-2 py-0.5 rounded-md bg-amber-500/15 text-amber-600 dark:text-amber-400 border border-amber-500/30 font-bold flex items-center gap-1">
                  <Sparkles className="h-3 w-3 text-amber-500" />
                  <span>🤖 Whisper AI đã cứu</span>
                </span>
              ) : result.transcript ? (
            ...
            <div className="text-base font-black font-jp text-foreground min-h-[1.75rem] flex items-center">
              {result.transcript ? (
                <span>“<UniversalFurigana text={result.transcript} fontSize="normal" />”</span>
              ) : (

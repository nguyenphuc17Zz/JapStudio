...
export const ALL_ACTION_DEFINITIONS: ActionDefinition[] = [
  ...
  // 4b. Aizuchi Dojo (/aizuchi)
  {
    key: "aizuchiSubmitOrNext",
    label: "Nộp Aizuchi / Chuyển Turn Kế Tiếp",
    category: "aizuchi",
    categoryLabel: "Phản Hồi Aizuchi",
    description: "Gửi câu chêm hoặc chuyển sang turn NPC tiếp theo",
    icon: <Check className="h-4 w-4 text-emerald-500" />,
  },
  {
    key: "aizuchiStartVoice",
    label: "Bắt Đầu Chêm / Kích Hoạt Mic",
    category: "aizuchi",
    categoryLabel: "Phản Hồi Aizuchi",
    description: "Kích hoạt micro để chêm aizuchi ngay",
    icon: <Mic className="h-4 w-4 text-rose-500" />,
  },
  {
    key: "aizuchiListenPrompt",
    label: "Nghe Lại Câu NPC (TTS)",
    category: "aizuchi",
    categoryLabel: "Phản Hồi Aizuchi",
    description: "Nghe lại câu nói của NPC",
    icon: <Volume2 className="h-4 w-4 text-primary" />,
  },
  {
    key: "aizuchiReplayModel",
    label: "Nghe Lại Mẫu Aizuchi Chuẩn",
    category: "aizuchi",
    categoryLabel: "Phản Hồi Aizuchi",
    description: "Nghe lại các mẫu chêm chuẩn bản xứ",
    icon: <Play className="h-4 w-4 text-sky-500" />,
  },
  {
    key: "aizuchiRetry",
    label: "Chêm Lại Turn Này (Retry)",
    category: "aizuchi",
    categoryLabel: "Phản Hồi Aizuchi",
    description: "Nghe lại NPC và chêm lại turn hiện tại",
    icon: <RotateCcw className="h-4 w-4 text-amber-500" />,
  },
  {
    key: "aizuchiSkip",
    label: "Bỏ Qua Turn Này (Skip)",
    category: "aizuchi",
    categoryLabel: "Phản Hồi Aizuchi",
    description: "Bỏ qua turn NPC hiện tại không chấm điểm",
    icon: <ArrowRight className="h-4 w-4 text-sky-500" />,
  },
  {
    key: "aizuchiPauseOrResume",
    label: "Tạm Dừng / Tiếp Tục Cửa Sổ Pause",
    category: "aizuchi",
    categoryLabel: "Phản Hồi Aizuchi",
    description: "Đóng băng cửa sổ pause để suy nghĩ kỹ",
    icon: <Clock className="h-4 w-4 text-amber-500" />,
  },
  {
    key: "aizuchiToggleReveal",
    label: "Xem Trước / Ẩn Đáp Án Mẫu Aizuchi",
    category: "aizuchi",
    categoryLabel: "Phản Hồi Aizuchi",
    description: "Làm mờ hoặc hiện đáp án chêm mẫu khi chưa nộp",
    icon: <Eye className="h-4 w-4 text-indigo-500" />,
  },
  {
    key: "aizuchiToggleHelp",
    label: "Bật / Tắt Bảng Phím Tắt Nhanh",
    category: "aizuchi",
    categoryLabel: "Phản Hồi Aizuchi",
    description: "Mở bảng tra cứu phím tắt nhanh",
    icon: <HelpCircle className="h-4 w-4 text-purple-500" />,
  },
  {
    key: "aizuchiOpenCheatsheet",
    label: "Mở Bảng Aizuchi Mẫu",
    category: "aizuchi",
    categoryLabel: "Phản Hồi Aizuchi",
    description: "Mở bảng tra cứu các kiểu chêm theo tình huống",
    icon: <BookOpen className="h-4 w-4 text-indigo-500" />,
  },
  {
    key: "aizuchiToggleInputMode",
    label: "Đổi Giữa Giọng Nói & Gõ Phím",
    category: "aizuchi",
    categoryLabel: "Phản Hồi Aizuchi",
    description: "Chuyển nhanh sang ô nhập liệu text",
    icon: <Edit3 className="h-4 w-4 text-purple-500" />,
  },

  // 4c. Sentence Builder (/builder)
  {
    key: "builderSubmitOrNext",
    label: "Nộp Câu / Chuyển Câu Kế Tiếp",
    category: "builder",
    categoryLabel: "Xây Câu",
    description: "Gửi câu đã xây hoặc chuyển sang câu tiếp theo",
    icon: <Check className="h-4 w-4 text-emerald-500" />,
  },
  {
    key: "builderStartVoice",
    label: "Bắt Đầu Nói / Kích Hoạt Mic",
    category: "builder",
    categoryLabel: "Xây Câu",
    description: "Kích hoạt micro để nói câu đã xây",
    icon: <Mic className="h-4 w-4 text-rose-500" />,
  },
  {
    key: "builderListenPrompt",
    label: "Nghe Lại Đề Bài (TTS)",
    category: "builder",
    categoryLabel: "Xây Câu",
    description: "Nghe lại từ khóa / câu gốc của đề",
    icon: <Volume2 className="h-4 w-4 text-primary" />,
  },
  {
    key: "builderReplayModel",
    label: "Nghe Lại Câu Mẫu Chuẩn",
    category: "builder",
    categoryLabel: "Xây Câu",
    description: "Nghe lại câu mẫu chuẩn sau khi hoàn thành",
    icon: <Play className="h-4 w-4 text-sky-500" />,
  },
  {
    key: "builderRetry",
    label: "Xây Lại Câu Này (Retry)",
    category: "builder",
    categoryLabel: "Xây Câu",
    description: "Xây lại câu hiện tại để cải thiện điểm nối",
    icon: <RotateCcw className="h-4 w-4 text-amber-500" />,
  },
  {
    key: "builderSkip",
    label: "Bỏ Qua Câu Này (Skip)",
    category: "builder",
    categoryLabel: "Xây Câu",
    description: "Bỏ qua câu khó không chấm điểm",
    icon: <ArrowRight className="h-4 w-4 text-sky-500" />,
  },
  {
    key: "builderPauseOrResume",
    label: "Tạm Dừng / Tiếp Tục Đồng Hồ",
    category: "builder",
    categoryLabel: "Xây Câu",
    description: "Đóng băng đồng hồ để suy nghĩ kỹ",
    icon: <Clock className="h-4 w-4 text-amber-500" />,
  },
  {
    key: "builderToggleReveal",
    label: "Xem Trước / Ẩn Câu Mẫu Xây",
    category: "builder",
    categoryLabel: "Xây Câu",
    description: "Làm mờ hoặc hiện câu mẫu chuẩn khi chưa nộp",
    icon: <Eye className="h-4 w-4 text-indigo-500" />,
  },
  {
    key: "builderToggleHelp",
    label: "Bật / Tắt Bảng Phím Tắt Nhanh",
    category: "builder",
    categoryLabel: "Xây Câu",
    description: "Mở bảng tra cứu phím tắt nhanh",
  ...
  {
    key: "builderOpenCheatsheet",
    label: "Mở Bảng Mẫu Nối Câu",
    category: "builder",
    categoryLabel: "Xây Câu",
    description: "Mở bảng tra cứu markers nối theo kỹ năng",
    icon: <BookOpen className="h-4 w-4 text-indigo-500" />,
  },
  {
    key: "builderToggleInputMode",
    label: "Đổi Giữa Giọng Nói & Gõ Phím",
    category: "builder",
    categoryLabel: "Xây Câu",
    description: "Chuyển nhanh sang ô nhập liệu text",
  ...
  // 4d. VI-JA Interpretation (/interpret)
  {
    key: "interpretSubmitOrNext",
    label: "Nộp Bản Dịch / Chuyển Câu Kế Tiếp",
    category: "interpret",
    categoryLabel: "Việt-Nhật",
    description: "Gửi bản dịch nói hoặc chuyển sang câu tiếp theo",
    icon: <Check className="h-4 w-4 text-emerald-500" />,
  },
  {
    key: "interpretStartVoice",
    label: "Bắt Đầu Dịch / Kích Hoạt Mic",
    category: "interpret",
    categoryLabel: "Việt-Nhật",
    description: "Kích hoạt micro để nói bản dịch",
    icon: <Mic className="h-4 w-4 text-rose-500" />,
  },
  {
    key: "interpretListenPrompt",
    label: "Nghe Lại Đề Việt (TTS)",
    category: "interpret",
    categoryLabel: "Việt-Nhật",
    description: "Nghe lại đề tiếng Việt",
    icon: <Volume2 className="h-4 w-4 text-primary" />,
  },
  {
    key: "interpretReplayModel",
    label: "Nghe Lại Bản Dịch Mẫu",
    category: "interpret",
    categoryLabel: "Việt-Nhật",
    description: "Nghe lại bản dịch Nhật mẫu chuẩn",
    icon: <Play className="h-4 w-4 text-sky-500" />,
  },
  {
    key: "interpretRetry",
    label: "Dịch Lại Câu Này (Retry)",
    category: "interpret",
    categoryLabel: "Việt-Nhật",
    description: "Dịch lại câu hiện tại để cải thiện fidelity",
    icon: <RotateCcw className="h-4 w-4 text-amber-500" />,
  },
  {
    key: "interpretSkip",
  ...
  {
    key: "interpretToggleReveal",
    label: "Xem Trước / Ẩn Bản Dịch Mẫu",
    category: "interpret",
    categoryLabel: "Việt-Nhật",
    description: "Làm mờ hoặc hiện bản dịch mẫu khi chưa nộp",
    icon: <Eye className="h-4 w-4 text-indigo-500" />,
  },
  {
    key: "interpretToggleHelp",
    label: "Bật / Tắt Bảng Phím Tắt Nhanh",
    category: "interpret",
    categoryLabel: "Việt-Nhật",
    description: "Mở bảng tra cứu phím tắt nhanh",
  ...
  {
    key: "interpretOpenCheatsheet",
    label: "Mở Bảng Bẫy Vietglish",
    category: "interpret",
    categoryLabel: "Việt-Nhật",
    description: "Mở bảng tra cứu lỗi Vietglish thường gặp",
    icon: <BookOpen className="h-4 w-4 text-indigo-500" />,
  },
  {
    key: "interpretToggleInputMode",
    label: "Đổi Giữa Giọng Nói & Gõ Phím",
    category: "interpret",
    categoryLabel: "Việt-Nhật",
    description: "Chuyển nhanh sang ô nhập liệu text",
        ...
        <div className="flex flex-col sm:flex-row gap-3 pt-2">
          ...
          <div className="flex items-center p-1 rounded-xl bg-muted/60 border border-border/80 overflow-x-auto scrollbar-thin">
            {[
              ...
              { id: "aizuchi", label: "Phản hồi (Aizuchi)" },
              { id: "builder", label: "Xây câu (Builder)" },
              { id: "interpret", label: "Việt-Nhật (Interpret)" },

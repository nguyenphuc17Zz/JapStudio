...
def test_tts_cache_key_generation():
    k1 = TTSCacheKey.create("  こんにちは   世界  ", "edge_tts", "ja-JP-NanamiNeural", speed=1.0)
    k2 = TTSCacheKey.create("こんにちは 世界", "EDGE_TTS", "ja-JP-NanamiNeural", speed=1.00)
    assert k1.to_hash() == k2.to_hash()

    # Different speed gives different hash
    k3 = TTSCacheKey.create("こんにちは 世界", "edge_tts", "ja-JP-NanamiNeural", speed=0.9)
    assert k1.to_hash() != k3.to_hash()

    # Different voice gives different hash
    k4 = TTSCacheKey.create("こんにちは 世界", "edge_tts", "ja-JP-KeitaNeural", speed=1.0)
...
def test_tts_cache_lru_and_ttl():
    ...
    k1 = TTSCacheKey.create("text1", "edge_tts", "ja-JP-NanamiNeural")
    k2 = TTSCacheKey.create("text2", "edge_tts", "ja-JP-NanamiNeural")
    k3 = TTSCacheKey.create("text3", "edge_tts", "ja-JP-NanamiNeural")

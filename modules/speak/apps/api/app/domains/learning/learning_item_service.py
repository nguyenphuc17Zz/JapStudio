...
class LearningItemService:
    ...
    async def update_item_from_result(
        ...
        # Automaticity: only update for reflex/keigo/situational timed exercises or when response_speed is available
        is_timed = context_tag.startswith(("reflex", "keigo", "situational", "aizuchi", "warikomi", "sentence", "interpret")) or (result.response_speed_ms is not None)

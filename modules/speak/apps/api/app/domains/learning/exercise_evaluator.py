                ...
                return ExerciseResult(
                    ...
                    metrics={
                        **_bld_metrics,
                        ...
                        "better_version": b_res.get("better_version") or _canonical,
                        "better_version_vi": b_res.get("better_version_vi") or _canonical_vi,
                        "errors": b_res.get("errors", []),
                        "praise_points": b_res.get("praise_points", []),
                        "meaning_score": b_res.get("meaning_score", 70),
                        "grammar_score": b_res.get("grammar_score", 70),
                        "naturalness_score": b_res.get("naturalness_score", 70),
                    },
                    independence=IndependenceLevel.ASSISTED_HINT if used_hint else IndependenceLevel.INDEPENDENT,
                    response_speed_ms=response_speed_ms,

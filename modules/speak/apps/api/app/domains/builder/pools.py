...
ASSEMBLE_SEEDS: list[dict[str, Any]] = [
    {
        ...
        "prompt_vi": "Kể với bạn là hôm qua xem phim với bạn, hay lắm luôn!",
        "situation_vi": "Kể là hôm qua xem phim với bạn, hay lắm",
        "template": "昨日、友達と見た映画がすごく______てさ！",
        "suggested_vocabulary": [
            {"term": "昨日", "reading": "きのう", "meaning_vi": "hôm qua"},
            {"term": "映画", "reading": "えいが", "meaning_vi": "bộ phim"},
            {"term": "友達", "reading": "ともだち", "meaning_vi": "bạn bè"},
            {"term": "面白い", "reading": "おもしろい", "meaning_vi": "thú vị, hay"},
        ],
        "connector_items": [
            {"term": "〜て", "meaning_vi": "và, rồi (nối tiếp)", "kind": "connector"},
            {"term": "〜くて", "meaning_vi": "thể て của tính từ -i", "kind": "connector"},
            {"term": "〜てさ", "meaning_vi": "đấy/á (cuối câu thân mật)", "kind": "ending"},
        ],
        "hints": [
            {"tier": 1, "title": "Hướng tư duy ngữ pháp", "content": "Dùng thể て của tính từ 面白い (おもしろくて) để nối cảm xúc."},
            {"tier": 2, "title": "Gợi ý từ nối", "content": "Dùng '友達と見た映画' (mệnh đề bổ nghĩa) + '面白くてさ'"},
            {"tier": 3, "title": "Khung sườn cấu trúc", "content": "昨日、友達と見た映画がめっちゃ______てさ！"},
            {"tier": 4, "title": "Câu mẫu hoàn chỉnh", "content": "昨日友達と見た映画がめっちゃ面白くてさ！"},
        ],
        "connectors": ["て", "で", "くて"],
        "canonical": "昨日友達と見た映画がめっちゃ面白くてさ！",
        "canonical_vi": "Hôm qua bộ phim xem cùng bạn hay cực kỳ luôn á!",
    },
    {
        "keywords": ["朝", "電車", "遅れる", "会社"],
        "starter": "今朝、電車が…",
        "focus_skill": "te_chain",
        "relation": "casual_friend",
        "prompt_vi": "Than thở với đồng nghiệp là sáng nay tàu điện bị trễ nên muộn giờ làm mất tiêu.",
        "situation_vi": "Kể là sáng nay tàu trễ nên muộn giờ làm",
        "template": "今朝、電車が______ちゃって、会社に______ちゃった。",
        "suggested_vocabulary": [
            {"term": "今朝", "reading": "けさ", "meaning_vi": "sáng nay"},
            {"term": "電車", "reading": "でんしゃ", "meaning_vi": "tàu điện"},
            {"term": "遅れる", "reading": "おくれる", "meaning_vi": "chậm, trễ"},
            {"term": "会社", "reading": "かいしゃ", "meaning_vi": "công ty"},
            {"term": "遅刻", "reading": "ちこく", "meaning_vi": "đi muộn"},
        ],
        "connector_items": [
            {"term": "〜ちゃって", "meaning_vi": "lỡ mất... rồi (nói tắt てしまって)", "kind": "connector"},
            {"term": "〜ので", "meaning_vi": "vì... nên", "kind": "connector"},
        ],
        "hints": [
            {"tier": 1, "title": "Hướng tư duy ngữ pháp", "content": "Dùng nói tắt 〜ちゃって (てしまって) để diễn tả việc ngoài ý muốn."},
            {"tier": 2, "title": "Gợi ý từ nối", "content": "遅れちゃって (chậm trễ mất rồi)"},
            {"tier": 3, "title": "Khung sườn cấu trúc", "content": "今朝電車が遅れちゃって、会社に遅刻______。"},
            {"tier": 4, "title": "Câu mẫu hoàn chỉnh", "content": "今朝電車が遅れちゃって、会社に遅刻しちゃった。"},
        ],
        "connectors": ["て", "で", "ので"],
        "canonical": "今朝電車が遅れちゃって、会社に遅刻しちゃった。",
        "canonical_vi": "Sáng nay tàu trễ nên mình bị muộn giờ làm mất tiêu.",
    },
    {
        "keywords": ["駅前", "開店", "ラーメン屋", "行列"],
        "starter": "駅前に…",
        "focus_skill": "relative_clause",
        "relation": "casual_friend",
        "prompt_vi": "Khoe với bạn về quán mì ramen mới mở trước ga, người ta đang xếp hàng dài ghê luôn!",
        "situation_vi": "Kể về quán ramen mới mở trước ga, đông xếp hàng",
        "template": "駅前に開店した______、すごい行列が______よ。",
        "suggested_vocabulary": [
            {"term": "駅前", "reading": "えきまえ", "meaning_vi": "trước nhà ga"},
            {"term": "開店", "reading": "かいてん", "meaning_vi": "khai trương, mở quán"},
            {"term": "ラーメン屋", "reading": "ラーメンや", "meaning_vi": "quán mì ramen"},
            {"term": "行列", "reading": "ぎょうれつ", "meaning_vi": "hàng người xếp hàng"},
        ],
        "connector_items": [
            {"term": "〜した [Danh từ]", "meaning_vi": "mệnh đề bổ nghĩa danh từ", "kind": "connector"},
            {"term": "〜てる", "meaning_vi": "đang (nói tắt ている)", "kind": "connector"},
        ],
        "hints": [
            {"tier": 1, "title": "Hướng tư duy ngữ pháp", "content": "Đặt động từ thể quá khứ trước danh từ: 開店したラーメン屋 (quán ramen đã mở)."},
            {"tier": 2, "title": "Gợi ý từ nối", "content": "行列ができてる (đang hình thành hàng dài)"},
            {"tier": 3, "title": "Khung sườn cấu trúc", "content": "駅前に開店したラーメン屋、すごい______ができてるよ。"},
            {"tier": 4, "title": "Câu mẫu hoàn chỉnh", "content": "駅前に開店したラーメン屋、すごい行列ができてるよ。"},
        ],
        "connectors": ["た", "ている", "てる"],
        "canonical": "駅前に開店したラーメン屋、すごい行列ができてるよ。",
        "canonical_vi": "Quán ramen mới mở trước ga đang xếp hàng dài ghê luôn.",
    },

...
TASK_TIER_MAPPING: dict[AITask, TaskTier] = {
    ...
    AITask.AIZUCHI_GENERATION: TaskTier.FAST,
    AITask.AIZUCHI_EVALUATION: TaskTier.FAST,
    AITask.BUILDER_GENERATION: TaskTier.FAST,
    AITask.BUILDER_EVALUATION: TaskTier.FAST,
    AITask.INTERPRET_GENERATION: TaskTier.FAST,
    AITask.INTERPRET_EVALUATION: TaskTier.FAST,
    AITask.INTERVIEW_COACH_QUESTION: TaskTier.FAST,
    AITask.INTERVIEW_COACH_EVALUATION: TaskTier.BALANCED,
}

...
class AITask(str, Enum):
    ...
    AIZUCHI_EVALUATION = "aizuchi_evaluation"
    BUILDER_GENERATION = "builder_generation"
    BUILDER_EVALUATION = "builder_evaluation"
    INTERPRET_GENERATION = "interpret_generation"
    INTERPRET_EVALUATION = "interpret_evaluation"
